...
そしたらrender_cv.rというRファイルが作成されるので、そのRコードをぶん回せばhtmlやpdfファイルが作成されるぞ！<br>
これで今後はSpreadsheetに情報を加える⇒render_cv.rを回す、というプロセスでモダンなCVを作り続けるマシーンになれる。細かい内容の習性はcv.rmdのセクション名を変えたりすればよい。ではまた。
