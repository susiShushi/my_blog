...
```docker:file
FROM jupyter/base-notebook /* Imageの作成 */
    
LABEL Description="Jupyter Octave" /* metadataの記述 */
    
USER root /* RUNさせるための権限付与 */

/* 作図用のgnuplotとOctaveをインスコ */
RUN apt-get update && \ 
...
<br><br>
このDockerfileができたら準備完了です（サラマンダーよりはやい）。
